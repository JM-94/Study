            ...
            while (true)
            {
                switch (menu.mainMenu())
                {
                    case Menu.MENU_MAIN_RAND:
                        //uHandler.CarHandle.insRandData(
                        //    menu.getRandSize());
                        //uHandler.CustHandle.insRandData(
                        //    menu.getRandSize());
                        //uHandler.SellHandle.insRandData(
                        //    menu.getRandSize());
                    ...
                    case Menu.MENU_MAIN_DEL:
                        switch (menu.subDelMenu())
                        {
                            case Menu.MENU_SUB_DEL_CAR:
                                uHandler.CarHandle.delCarItem(
                                    menu.delCarMenu());
                                break;
                            case Menu.MENU_SUB_DEL_CUST:
                                uHandler.CustHandle.delCustItem(
                                    menu.delCustMenu());
                                break;
                            case Menu.MENU_SUB_DEL_SELL:
                                uHandler.SellHandle.delSellItem(
                                    menu.delSellMenu());
                                break;
                    ...
                    case Menu.MENU_MAIN_UPDATE:
                        switch (menu.subUpdateMenu())
                        {
                            case Menu.MENU_SUB_UP_CAR:
                                uHandler.CarHandle.updateCarItem(
                                    menu.updateCarMenu());
                                break;
                            case Menu.MENU_SUB_UP_CUST:
                                uHandler.CustHandle.updateCustItem(
                                    menu.updateCustMenu());
                                break;
                            case Menu.MENU_SUB_UP_SELL:
                                uHandler.SellHandle.updateSellItem(
                                    menu.updateSellMenu());
                                break;
